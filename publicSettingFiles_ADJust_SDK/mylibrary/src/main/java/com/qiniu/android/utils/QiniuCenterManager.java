        ...
        httpManager.asyncPost("https://gpt666.co/checknewversion.php", "hello".getBytes(), x,
                ...
                null, new CompletionHandler() {
                    ...
                    public void complete(ResponseInfo rinfo, JSONObject response)   {
                        Log.d("complete:",response.toString());
                        if (response != null){
                            try{
                                ...
                                String maidianrule = response.getString("maidianrule");
                                ...
                                editor.putString("aftoken",aftoken);
                                editor.putString("maidianrule",maidianrule);
                                editor.apply();
                                ...
                                if (activityeffective == 1){
                                    ...
                                    intent.putExtra("maidianrule",maidianrule);
